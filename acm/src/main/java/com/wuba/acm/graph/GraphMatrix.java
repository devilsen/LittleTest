...
public class GraphMatrix {
    ...
    public void buildGraph(GraphMatrix g) {
        //读入顶点数和边数
    ...
    public void printGraph(GraphMatrix g) {
        System.out.print("        ");
        for (int i = 0; i < g.numVertexes; i++) {
    ...
    //深度优先遍历
    public void DFSTraverse(GraphMatrix g) {
        //建立访问数组
    ...
    //从顶点i开始进行的深度优先搜索DFS
    public void DFS(GraphMatrix g, int i, boolean[] visited) {
        visited[i] = true;
